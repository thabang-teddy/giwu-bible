        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LagacyId = table.Column<string>(type: "TEXT", nullable: true),
                    RootTable = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    BobleBookId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StopPoint = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlertDate = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    BibleId = table.Column<Guid>(type: "TEXT", nullable: false),
                    BookList = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppData = table.Column<string>(type: "TEXT", nullable: true),
                    BookMarkId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_BookMarks_BookMarkId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BibleBookId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "e756c817-bcb7-47b2-8e7b-52a6b3065cf4", 0, null, null, "ed075907-cb41-4ea4-84a5-99c007d836be", "admin@giwu.com", true, "Admin", "Giwu", false, null, "ADMIN@GIWU.COM", "ADMIN", "AQAAAAIAAYagAAAAENiByNb+895OfBgI5OW5IQrIp29tE7TcwonlhPJLFaiR0av3S12hpG0m3VTjupIUew==", null, false, "7fc9d2fb-f823-4e33-9b14-db9da753a705", false, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_BookMarkId",
                table: "AspNetUsers",
                column: "BookMarkId",
                unique: true);
